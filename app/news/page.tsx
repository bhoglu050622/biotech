...
const blogPosts = [
  ...
  {
    title: 'Next-Generation Pilot Headgear – Expanding Vision Beyond Limits',
    date: 'September 2025',
    summary: 'In modern aerial combat, information is power. Our Next-Generation Pilot Headgear integrates multi-camera vision, AI-assisted overlays, and biometric tracking to provide pilots with unparalleled situational awareness.',
    icon: Plane,
