...
const navItems = [
  ...
  { 
    ...
    href: '/technologies',
    dropdown: [
      { label: 'Neurotech Systems', href: '/technologies#neuro-systems' },
  ...
  { 
    ...
    href: '/products',
    dropdown: [
      { label: 'EEG Solutions', href: '/products#eeg-solutions' },
      { label: 'Next-Generation Pilot Headgear', href: '/products#pilot-headgear' }
    ]
  },
  { 
    label: 'Solutions', 
